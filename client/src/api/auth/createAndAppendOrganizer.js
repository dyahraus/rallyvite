...
import { appendOrganizerToEvent } from './appendOrganizerToEvent';

export const createAndAppendOrganizer = async ({
  name,
  email,
  phone,
  eventUuid,
  ...
  try {
    ...
    if (
      ...
      const eventUser = await appendOrganizerToEvent(eventUuid, userUuid);
